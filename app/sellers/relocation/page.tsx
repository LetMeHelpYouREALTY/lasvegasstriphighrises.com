...
const pageSchemas = combineSchemas(
  ...
  generateWebPageSchema({
    name: "Relocation Home Sales Las Vegas",
    description:
      "Dr. Jan Duffy helps relocating homeowners sell in Las Vegas and coordinates with Berkshire Hathaway HomeServices offices nationwide.",
    url: "/sellers/relocation",
    dateModified: "2026-09-25",
  }),
  generateServiceSchema({
    name: "Relocation Home Sales",
    description:
      "Remote-friendly listing and coordination for Las Vegas homeowners leaving for a new job or city.",
    url: "/sellers/relocation",
  }),
);
...
export default function RelocationPage() {
  return (
    <>
      <SchemaScript schema={pageSchemas} id="seller-relocation-schema" />
      <Navbar />
