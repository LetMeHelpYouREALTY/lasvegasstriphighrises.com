...
const pageSchemas = combineSchemas(
  ...
  generateWebPageSchema({
    name: "Divorce & Probate Home Sales Las Vegas",
    description:
      "Sensitive real estate situations handled with discretion. Dr. Jan Duffy helps with divorce sales, probate, estate liquidation, and court-ordered sales.",
    url: "/sellers/divorce-probate",
    dateModified: "2026-09-25",
  }),
  generateServiceSchema({
    name: "Divorce and Probate Home Sales",
    description:
      "Neutral, documented home sales for divorce, probate, and court-ordered situations in Las Vegas and Henderson.",
    url: "/sellers/divorce-probate",
  }),
);
...
export default function DivorceProbatePage() {
  return (
    <>
      <SchemaScript schema={pageSchemas} id="divorce-probate-schema" />
      <Navbar />
      <main className="pt-32 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <SectionVisual
              heading="Divorce & Probate Expert Guidance"
              ...
              <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-slate-600 mb-4">
                    ...
                    representation. We work with both parties and their
                    attorneys to ensure a fair sale process.
                  </p>
          ...
          <VisitOffice heading="Confidential visit at Lake Mead Boulevard" />
